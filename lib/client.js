...
var TASK_SIZE_LABEL = { short: "\u5C0F\u4EFB\u52A1", medium: "\u4E2D\u7B49\u4EFB\u52A1", long: "\u957F\u4EFB\u52A1" };
var PARTICIPATION_GOAL_LABEL = { fast_finish: "\u5FEB\u901F\u5B8C\u6210", balanced: "\u5E73\u8861\u6A21\u5F0F", learning: "\u7EC3\u4E60\u5224\u65AD" };
...
var PREFERENCE_KEY = "your-turn-dsh:preference-profile:v1";
var VIEWPORT_GAP = 8;
...
function TaskProfileControls({ profile = {}, busy, disabled, onChange }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "hil-card hil-profile hil-task-profile-controls", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-segment", children: Object.entries(TASK_SIZE_LABEL).map(([value, label]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: `hil-segment-btn ${taskSize === value ? "active" : ""}`, disabled: busy || disabled, onClick: () => onChange({ taskSize: value }), children: label }, value)) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-segment", children: Object.entries(PARTICIPATION_GOAL_LABEL).map(([value, label]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: `hil-segment-btn ${participationGoal === value ? "active" : ""}`, disabled: busy || disabled, onClick: () => onChange({ participationGoal: value }), children: label }, value)) })
  ] });
}
function TaskProfileTags({ profile = {} }) {
  const taskSize = profile.taskSize ?? "medium";
  const participationGoal = profile.participationGoal ?? "balanced";
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "hil-status-tags", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "hil-mode", children: TASK_SIZE_LABEL[taskSize] ?? TASK_SIZE_LABEL.medium }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "hil-mode", children: PARTICIPATION_GOAL_LABEL[participationGoal] ?? PARTICIPATION_GOAL_LABEL.balanced })
  ] });
}
function RecallPolicyDebug({ state, node }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `hil-card hil-debug ${auto ? "auto" : "recall"}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: auto ? "AI \u81EA\u52A8\u7EE7\u7EED" : "Recall Policy" }),
    auto && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "hil-copy", children: "\u8FD9\u4E00\u6B65\u8BC4\u4F30\u8FC7\u662F\u5426\u9700\u8981 Your Turn\uFF0C\u4F46\u5F53\u524D\u6253\u6270\u4EF7\u503C\u4E0D\u591F\u9AD8\uFF0C\u6240\u4EE5\u6CA1\u6709\u6682\u505C\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "hil-debug-grid", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Recall Value" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: formatScore(decision.recallValue) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Threshold" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: formatScore(decision.threshold ?? budget?.threshold) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Decision" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: auto ? "Skipped Your Turn" : decision.action ?? "\u2014" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Reason" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: reason }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Auto Risk" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: formatScore(decision.autoRisk) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Human Value" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: formatScore(decision.humanValue) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Task Size" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: TASK_SIZE_LABEL[budget?.taskSize ?? profile.taskSize] ?? "\u4E2D\u7B49\u4EFB\u52A1" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Goal" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: PARTICIPATION_GOAL_LABEL[budget?.participationGoal ?? profile.participationGoal] ?? "\u5E73\u8861\u6A21\u5F0F" }),
      budget?.preferencePreset && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Preference" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: budget.preferencePreset })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Recall Count" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: budget ? `${budget.recallCount} / ${budget.maxRecall}` : `${state.recallState?.recallCount ?? 0} / \u2014` })
    ] })
  ] });
}
function PreferenceProfileControls({ profile, busy, onEdit }) {
  const summary = profile?.summary || "\u9ED8\u8BA4 Your Turn \u504F\u597D";
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "hil-card hil-profile", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-label", children: "Your Turn \u504F\u597D" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "hil-copy", children: summary }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "hil-btn", disabled: busy, onClick: onEdit, children: "\u7F16\u8F91\u504F\u597D" })
  ] });
}
function MoreInfo({ state, node, hovered, suggestion, draft, setDraft, onEdit }) {
  const completed = node.status === "completed";
  const basis = node.recallReason || node.rationale;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { className: "hil-more", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("summary", { children: "\u66F4\u591A\u4FE1\u606F" }),
    !hovered && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RecallPolicyDebug, { state, node }),
    " ",
    !hovered && !suggestion && !completed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-label", children: "\u5F53\u524D\u5206\u5DE5" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-readonly-value", children: nodeModeLabel(node) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-label", children: "\u51B3\u7B56\u4F9D\u636E" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "hil-copy", children: basis }),
    !!node.evidence.length && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-label", children: "\u6750\u6599\u4E0E\u8BC1\u636E" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "hil-list", children: node.evidence.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: item }, item)) })
    ] }),
    !hovered && !completed && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-label", children: "\u8C03\u6574\u5F53\u524D\u6B65\u63D0\u793A\u8BCD" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", { className: "hil-textarea", value: draft, onChange: (event) => setDraft(event.target.value) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "hil-btn", disabled: !draft.trim() || draft === node.instruction, onClick: () => onEdit(node, draft), children: "\u4FDD\u5B58\u63D0\u793A\u8BCD" })
    ] })
  ] });
}
...
function HumanLoopOverlay({ call }) {
  ...
  const [localPreference, setLocalPreference] = (0, import_react.useState)(() => readPreferenceProfile());
  ...
  const migratingPreferenceRef = (0, import_react.useRef)(false);
  const savedPreferenceRef = (0, import_react.useRef)("");
  ...
  (0, import_react.useEffect)(() => {
    if (open) setLocalPreference(readPreferenceProfile());
  }, [open]);
  (0, import_react.useEffect)(() => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    dispatch({ type: "CONFIRM_PREFERENCE_MIGRATION", profile: localPreference }).finally(() => {
      migratingPreferenceRef.current = false;
    });
      ...
      drawerOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", { ref: drawerRef, className: "hil-drawer", style: drawerStyle(railPosition, drawerTop, viewport, drawerHeight), "aria-label": "\u8282\u70B9\u8BE6\u60C5", onMouseEnter: keepPreview, onMouseLeave: () => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { className: "hil-detail", children: [
          !hovered && summaryOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outcome, { state, busy, onAccept: () => dispatch({ type: "ACCEPT_FINAL_RESULT" }) }) : !detailNode ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-card", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "\u7B49\u5F85 Agent \u53D1\u5E03\u8DEF\u5F84" }) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "hil-status-row", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "hil-mode", children: STATUS_LABEL[detailNode.status] }),
              detailNode.status !== "pending" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TaskProfileTags, { profile: state.taskProfile })
            ] }),
            ...
            !hovered && detailNode.status === "pending" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TaskProfileControls, { profile: state.taskProfile, busy, disabled: detailNode.status !== "pending", onChange: updateTaskProfile }),
            !hovered && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PreferenceProfileControls, { profile: state.preferenceProfile, busy, onEdit: startPreferenceOnboarding }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MoreInfo, { state, node: detailNode, hovered, suggestion, draft, setDraft, onEdit: (node, instruction) => dispatch({ type: "EDIT_INSTRUCTION", nodeId: node.id, instruction }) })
          ] }),
