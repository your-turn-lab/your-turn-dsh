...
function TaskProfileControls({ profile = {}, busy, onChange }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "hil-card hil-profile", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-label", children: "\u4EFB\u52A1\u89C4\u6A21" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-segment", children: Object.entries(TASK_SIZE_LABEL).map(([value, label]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: `hil-segment-btn ${taskSize === value ? "active" : ""}`, disabled: busy, onClick: () => onChange({ taskSize: value }), children: label }, value)) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-label", children: "\u53C2\u4E0E\u76EE\u6807" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-segment", children: Object.entries(PARTICIPATION_GOAL_LABEL).map(([value, label]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: `hil-segment-btn ${participationGoal === value ? "active" : ""}`, disabled: busy, onClick: () => onChange({ participationGoal: value }), children: label }, value)) })
  ] });
}
      ...
      drawerOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", { ref: drawerRef, className: "hil-drawer", style: drawerStyle(railPosition, drawerTop, viewport, drawerHeight), "aria-label": "\u8282\u70B9\u8BE6\u60C5", onMouseEnter: keepPreview, onMouseLeave: () => {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { className: "hil-detail", children: [
          !hovered && summaryOpen ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outcome, { state, busy, onAccept: () => dispatch({ type: "ACCEPT_FINAL_RESULT" }) }) : !detailNode ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hil-card", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "\u7B49\u5F85 Agent \u53D1\u5E03\u8DEF\u5F84" }) }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
            ...
            !hovered && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TaskProfileControls, { profile: state.taskProfile, busy, onChange: updateTaskProfile }),
            ...
            !hovered && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RecallPolicyDebug, { state, node: detailNode }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MoreInfo, { node: detailNode, hovered, suggestion, draft, setDraft, onEdit: (node, instruction) => dispatch({ type: "EDIT_INSTRUCTION", nodeId: node.id, instruction }) })
          ] }),
